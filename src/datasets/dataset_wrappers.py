...
def heloc(path: str = "data/heloc.csv") -> dict:
    """
    Load the heloc dataset.

    Parameters:
        - path: the path to the heloc dataset (str)
    """
...
def give_me_some_credit(path: str = "data/give_me_some_credit.csv") -> dict:
    """
    Load the give_me_some_credit dataset.

    Parameters:
        - path: the path to the give_me_some_credit dataset (str)
    """
    ...
    categorical_columns = []
    continuous_columns = raw_df.columns.tolist()
    continuous_columns.remove("SeriousDlqin2yrs")
