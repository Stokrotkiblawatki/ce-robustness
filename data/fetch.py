...
# Nie ma heloc ani give me some credits w ucimlrepo
# trzeba pobrać

# heloc - target var is RiskPerformance (last)

# give me some credit  - target var is SeriousDlqin2yrs (last)

# no need to do anything here, i just download manually
